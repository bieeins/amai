...
class users extends Seeder
{
    ...
    public function run()
    {
        $user = [
            ...
            ['id_ProgramStudi' => 1, 'username' => 'users', 'full_Name' => 'Users Admin', 'email' => 'admin@amai.com', 'password' => bcrypt('123123'), 'roles' => 'admin', 'status' => 'enable'],
            ...
            ['id_ProgramStudi' => 1, 'username' => 'reviewer', 'full_Name' => 'reviewer', 'email' => 'review@amai.com', 'password' => bcrypt('123123'), 'roles' => 'reviewer', 'status' => 'enable'],
            ['id_ProgramStudi' => 1, 'username' => 'tes', 'full_Name' => 'tes aja', 'email' => 'tes@amai.com', 'password' => bcrypt('123123'), 'roles' => 'reviewer', 'status' => 'enable'],
            ['id_ProgramStudi' => 1, 'username' => 'tess', 'full_Name' => 'tess aja', 'email' => 'tess@amai.com', 'password' => bcrypt('123123'), 'roles' => 'prodi', 'status' => 'enable'],
        ];
